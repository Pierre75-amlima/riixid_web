...
export interface ApiActualiteActualite extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    content: Schema.Attribute.DynamicZone<
      ['sections.section', 'sections.image-block', 'sections.cta-block']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiApproachCardApproachCard
  extends Struct.CollectionTypeSchema {
  collectionName: 'approach_cards';
  info: {
    displayName: 'Approach Card';
    pluralName: 'approach-cards';
    singularName: 'approach-card';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::approach-card.approach-card'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiExpertiseExpertise extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variant: Schema.Attribute.Enumeration<['light', 'orange', 'dark']> &
...
export interface ApiNewsletterItemNewsletterItem
  extends Struct.CollectionTypeSchema {
  collectionName: 'newsletter_items';
  info: {
    displayName: 'Newsletter Item';
    pluralName: 'newsletter-items';
    singularName: 'newsletter-item';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::newsletter-item.newsletter-item'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    readTime: Schema.Attribute.String;
...
export interface ApiValueValue extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variant: Schema.Attribute.Enumeration<['orange', 'white', 'black']> &
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::approach-card.approach-card': ApiApproachCardApproachCard;
      'api::contact-message.contact-message': ApiContactMessageContactMessage;
      'api::expertise.expertise': ApiExpertiseExpertise;
      'api::home-page.home-page': ApiHomePageHomePage;
      'api::newsletter-item.newsletter-item': ApiNewsletterItemNewsletterItem;
