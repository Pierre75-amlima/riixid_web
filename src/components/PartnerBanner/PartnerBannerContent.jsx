...
export default function PartnerBannerContent() {
  return (
    <div className="relative z-10 mx-auto max-w-6xl text-center">
      {/* Titre principal */}
      <h1 className="text-10xl font-extrabold uppercase leading-tight text-white md:text-6xl">
      ...
      {/* Description */}
      <p className="mx-auto mt-2 max-w-2xl text-sm leading-snug text-white/80">
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
        ...
        {/* Bouton secondaire */}
        <button className="rounded-full border border-white/70 px-6 py-3 font-medium text-white ">
